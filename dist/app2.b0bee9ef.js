...
$tabBar.on("click", "li", function (e) {
  ...
  var $li = (0, _jquery.default)(e.currentTarget); //点击加class，  .siblings remove class

  $li.addClass("selected").siblings().removeClass("selected");
  var index = $li.index(); //找到content的children列表，索引到index项，添加删除content的active class

  $tabContent.children().eq(index) //索引到index项
